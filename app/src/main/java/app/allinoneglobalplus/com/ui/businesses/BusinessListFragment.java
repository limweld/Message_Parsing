...
public class BusinessListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        callback.onItemSelected(BusinessContent.ITEMS.get(position).id);
    }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return BusinessContent.ITEMS.size();
        }

        @Override
        public Object getItem(int position) {
            return BusinessContent.ITEMS.get(position);
        }

        @Override
        public long getItemId(int position) {
            return BusinessContent.ITEMS.get(position).id.hashCode();
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            final BusinessContent.DummyItem item = (BusinessContent.DummyItem) getItem(position);
