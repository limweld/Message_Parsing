 ...
 */
public class GetPhilHealthPremium extends AsyncTask<String, Void, String> {
    private ProgressDialog dialog;

    public GetPhilHealthPremium(LoginActivity activity) {
    ...
    protected void onPostExecute(String result) {
        try {
            ...
            JSONArray articles = json.getJSONArray("philhealthpremium");
            ...
            for(int i = 0; i<=articles.length(); i++) {
                ...
                PhilHealthPremium pro = new PhilHealthPremium(s2,s3);
                pro.Insert();
            }
